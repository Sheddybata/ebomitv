...
export default function VideoCardEnhanced({ 
  ...
  const isPartiallyWatched = watchProgress > 5 && watchProgress < 95;

  return (
    <motion.div
      className="group relative glass-card rounded-2xl overflow-hidden cursor-pointer hover:border-ministry-gold/30 transition-all duration-300"
    ...
    >
      ...
      <div className="relative aspect-video bg-gradient-to-br from-background to-[rgba(var(--foreground),0.1)] overflow-hidden">
        ...
        {/* Featured Badge */}
        {video.featured && !isPartiallyWatched && (
